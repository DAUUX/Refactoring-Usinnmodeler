		...
		onSubmit: async values => {
            ...
            try {
                ...
                if(name !== formik.values.name){
                    ...
                    await api.post('notification', {user_id: filtered_user_ids, diagram_id: diagram_id, type: 2, message: `"${collaborator_name}" alterou o nome do ${owner ? 'diagrama compartilhado com você' : 'seu diagrama'}: "${name}" para "${formik.values.name}"`})
