            ...
            >
              ...
              {mouseHover === item.id ? (
                <span className="d-flex fs-6">
                  <button className="btn btn-default p-0 px-2 text-white" onClick={(e) => handleRead(e, item.id, item.read)} aria-label={item.read === 0 ? t('botão para marcar a notificação como lida') : t('botão para marcar a notificação como não lida')}>
